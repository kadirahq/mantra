...
> All the following Mantra components reside in the client side of your app.
...
> Inside an action, everything you do should be based on applications context and other arguments passed to the action.
> You should not require other modules or use Global variables inside actions or the module action stays.
...
[Click here for some containers in Mantra](https://github.com/mantrajs/mantra-sample-blog-app/tree/master/client/containers)
...
[Click here for an example application context in Mantra](https://github.com/mantrajs/mantra-sample-blog-app/blob/master/client/configs/context.js)
...
[Click here for an example configuration](https://github.com/mantrajs/mantra-sample-blog-app/blob/master/client/configs/routes.jsx#L13)
...
> For the server, you can have a separate entry point.
