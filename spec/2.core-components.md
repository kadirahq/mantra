...
**When we discuss about Mantra further in this specification, it's about the client side of your app.**

However, most of the apps will have server side components. So, we've a directory layout for server side as well. For that, refer [Appendix B](#sec-Appendix-Server-Side-Directory-Layout).
...
There could be multiple ways to organize modules depending on the app. Refer [Appendix C](#sec-Appendix-Organizing-Modules) for some of those methods.
