...
NOTE: In this section, we only discuss about the client side directory layout. To learn about how to organize server the side directory layout refer [Appendix B](#sec-Appendix-Server-Side-Directory-Layout).
...
In the tests directory, we write tests for each action module with it's name. Refer [Appendix D](#sec-Appendix-File-Naming-Conventions) to learn more about test file naming conventions.
...
Just like in actions, we have a tests directory that contains tests. Refer [Appendix D](#sec-Appendix-File-Naming-Conventionssec-Appendix-File-Naming-Conventions) for test file naming conventions.
...
This directory also has a `tests` directory which contain tests. Refer [Appendix D](#sec-Appendix-File-Naming-Conventions) for test file naming conventions.
