...
All the JavaScript files in this directory must export a default function which initiate any task and return something if needed. That function may accept "Application Context" as the first argument.
...
This directory contains a set of JavaScript files(`.js` or `.jsx`) which exports a set of utility (pure) functions. This directory also has a `tests` directory which contains tests.
